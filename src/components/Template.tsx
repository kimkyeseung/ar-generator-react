      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8">
        <header className="space-y-4 text-center">
          ...
          <p className="mx-auto max-w-2xl text-sm text-slate-400">
            Switch between the AFRAME scene and the Three.js integration to
            compare different ways of embedding MindAR inside a React
            application.
          </p>
        </header>

        <Navigation />
        <main className="mt-4">main elements</main>
      </div>
    </div>
  )
}
