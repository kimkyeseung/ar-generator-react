...
class w {
  ...
  filter(t, i) {
    ...
    const { xPrev: n, tPrev: o, dxPrev: s } = this,
      r = t - o,
      u = h(r, this.dCutOff),
      c = [],
      d = [],
...
class k {
  constructor({ uiLoading: t, uiScanning: i, uiError: n }) {
    ...
    ;((o.innerText = b),
      ...
      t === 'yes'
        ? (this.loadingModal = this._loadHTML(f))
        : t !== 'no' && (this.loadingModal = document.querySelector(t)),
      n === 'yes'
        ? (this.compatibilityModal = this._loadHTML(v))
        : n !== 'no' && (this.compatibilityModal = document.querySelector(n)),
      i === 'yes'
...
export { w as O, k as U, x as c, M as g }
