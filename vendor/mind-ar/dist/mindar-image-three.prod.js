...
class K {
  constructor(e) {
    ...
    ;(e.startsWith(K.URL_SCHEME) && (e = e.slice(K.URL_SCHEME.length)),
      (e == null || e.length === 0) && (e = ud),
      (this.modelJsonFileName = e + ld),
      (this.weightDataFileName = e + pd))
  }
  async save(e) {
      ...
      )
    {
      ...
      if (
        ...
        (o.href = n),
        await xt(() => o.dispatchEvent(new MouseEvent('click'))),
        e.weightData != null)
      ) {
        const u =
        ...
        ;((u.download = this.weightDataFileName),
          (u.href = t),
          await xt(() => u.dispatchEvent(new MouseEvent('click'))))
      }
...
class md {
  ...
  loadWeights(e) {
    const t = [],
      a = []
    for (const o of e) (t.push(...o.weights), a.push(...o.paths))
    const r = this.checkManifestAndWeightFiles(e),
      n = a.map((o) => this.loadWeightsFile(o, r[o]))
  ...
  checkManifestAndWeightFiles(e) {
    const t = [],
      a = this.weightsFiles.map((n) => Dt(n.name)),
      r = {}
    for (const n of e)
      n.paths.forEach((o) => {
        const u = Dt(o)
        if (t.indexOf(u) !== -1)
          throw new Error(
            `Duplicate file basename found in weights manifest: '${u}'`
          )
...
const cd = (s) =>
  z().getBool('IS_BROWSER') && !Array.isArray(s) && s.startsWith(K.URL_SCHEME)
    ? dd(s.slice(K.URL_SCHEME.length))
    : null
 ...
 * =============================================================================
 */
const Td = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      confusionMatrix: wd,
...
function Pe(s, e, t) {
  ...
  if (((X(s) || X(e)) && (a = !1), X(s) && X(e) && (a = !0), a)) {
    ...
    if (o !== u)
      throw new Error(
        `Arrays are of different type. Actual: ${o}. Expected: ${u}`
      )
  }
  if (Array.isArray(s) && Array.isArray(e)) {
    ...
    if (!le(o, u))
      throw new Error(
        `Arrays have different shapes. Actual: [${o}]. Expected: [${u}]`
      )
  }
  const r = X(s) ? s : It(s),
    n = X(e) ? e : It(e)
...
function _d(s, e) {
  const t =
    typeof e == 'string' || typeof e == 'number' || typeof e == 'boolean'
      ? [e]
      : e
  return de(s) || de(s[0]) || de(e) || de(e[0])
    ? Pe(s, t, (a, r) => a == r)
    : Pe(s, e, (a, r) => yt(a, r, 0))
}
function Ad(s, e, t) {
...
function xd(s, e, t, a, r, n) {
  const o = y(s, 'forgetBias', 'basicLSTMCell'),
    u = y(e, 'lstmKernel', 'basicLSTMCell'),
    l = y(t, 'lstmBias', 'basicLSTMCell'),
    m = y(a, 'data', 'basicLSTMCell'),
    p = y(r, 'c', 'basicLSTMCell'),
...
function Ld(s, e, t, a = !1) {
  const r = y(s, 'x', 'denseBincount'),
    n = y(e, 'weights', 'denseBincount')
  ;(N(
    r.dtype === 'int32',
    () =>
    ...
    N(t >= 0, () => `size must be non-negative, but got ${t}.`),
    N(
      n.size === r.size || n.size === 0,
      () =>
        `Error in denseBincount: weights must have the same shape as x or 0-length, but got x shape: ${r.shape}, weights shape: ${n.shape}.`
    ))
  const o = { x: r, weights: n },
    u = { size: t, binaryOutput: a }
 ...
 */
function Pd(s, ...e) {
  const t = e.map((r, n) => y(r, `tensors${n}`, 'einsum')),
    a = { equation: s }
...
function Vd(s, e, t = 'left') {
  ...
  if (u.shape[1] >= he)
    throw new Error(
      `trailing dim_size must less than ${he} for int32 output type, was ${u.shape[1]}`
    )
  const m = {
      sortedSequence: u,
      values: l,
...
function Rd(s, e, t, a, r = !1) {
  const o = { x: y(s, 'x', 'maxPoolWithArgmax') },
    u = { filterSize: e, strides: t, pad: a, includeBatchInIndex: r },
    l = O.runKernel(as, o, u)
...
function ln(s, e, { indexing: t = 'xy' } = {}) {
  ...
  return t === 'xy'
    ? ((a = v(a, [1, -1])),
      (r = v(r, [-1, 1])),
      [B(Z([o, 1], a.dtype), a), B(r, Z([1, n], r.dtype))])
    : ((a = v(a, [-1, 1])),
      (r = v(r, [1, -1])),
      [B(a, Z([1, o], a.dtype)), B(Z([n, 1], r.dtype), r)])
}
function jd(s, e, t, a) {
  const r = y(e, 'data', 'multiRNNCell'),
    n = Ct(t, 'c', 'multiRNNCell'),
    o = Ct(a, 'h', 'multiRNNCell')
  let u = r
  const l = []
  ...
  const m = [],
    p = []
  for (let c = 0; c < l.length; c += 2) (m.push(l[c]), p.push(l[c + 1]))
  return [m, p]
}
...
function Bd(s, e, t, a = !1) {
  ...
  t = t || Math.random()
  const l = { logits: o === 1 ? v(r, [1, -1]) : r },
    m = { numSamples: e, seed: t, normalized: a },
    p = O.runKernel(rs, l, m)
...
function Wd(s, e, t = 0) {
  return (
    N(e.length === 2, () => 'Invalid number of paddings. Must be length of 2.'),
    te(s, [e], t)
  )
}
 ...
 */
function Kd(s, e, t, a) {
  const r = s.map((p, c) => y(p, `tensors${c}`, 'raggedGather', 'int32')),
    n = y(e, 'paramsDenseValues', 'raggedGather'),
    o = y(t, 'indices', 'raggedGather', 'int32'),
    u = {
...
function Jd(s, e, t, a, r) {
  const n = y(s, 'shape', 'raggedTensorToTensor', 'int32'),
    o = y(e, 'values', 'raggedTensorToTensor'),
    u = y(t, 'defaultValue', 'raggedTensorToTensor', o.dtype),
...
function Xd(s, e, t = 1, a = 'float32', r) {
  ...
  const n = new ki(e, t, a, r),
    o = Xe(s, a)
  for (let u = 0; u < o.values.length; u++) o.values[u] = n.nextValue()
  return o.toTensor()
}
...
async function sh(s, e) {
  ...
  ;(N(
    ...
    N(t.rank === 1, () => `x should be 1D tensor, but got x (${t.shape}).`),
    N(a.rank === 1, () => `y should be 1D tensor, but got y (${a.shape}).`))
  const r = await t.data(),
    n = await a.data(),
    o = new Set(n)
  let u = 0
  for (let p = 0; p < r.length; p++) o.has(r[p]) || u++
  const l = new ze([u], t.dtype),
    m = new ze([u], 'int32')
...
async function rh(s, e, t) {
  ...
  let l = 1
  for (let f = n; f < n + o; f++) l *= u[f]
  const m = u.slice(0, n).concat([l], u.slice(n + o)),
    p = v(a, m),
    c = v(r, [-1]),
    d = await gt(c),
    h = et(d, [1]),
...
function nh(s, e, t, a, r = !0) {
  const n = y(s, 'v', 'movingAverage'),
    o = y(e, 'x', 'movingAverage'),
    u = y(t, 'decay', 'movingAverage')
...
function uh(s, e, t, a = 0) {
  const r = y(s, 'sparseIndices', 'sparseToDense', 'int32'),
    ...
    o = y(a, 'defaultValue', 'sparseToDense', n.dtype)
  oh(r, n, t, o)
  const u = {
      sparseIndices: r,
      sparseValues: n,
...
async function ph(s, e, t = 1) {
  ...
  for (let c = 0; c < l; c++) {
    const d = c * m,
      h = o.subarray(d, d + m),
      b = []
    for (let f = 0; f < h.length; f++) b.push({ value: h[f], index: f })
...
function mh({
  ...
  let h = c,
    b = !1
  ;(c.rank === 3 &&
    ((b = !0), (h = v(c, [1, c.shape[0], c.shape[1], c.shape[2]]))),
    N(
      h.rank === 4,
      () =>
  ...
  let g
  u != null &&
    ((g = y(u, 'bias', 'fused conv2d')),
    ([g] = Pi(g, c)),
    Vi(f.outShape, g.shape))
  let S
  ...
  const k = (A, $) => {
      ...
      const [L, Q, x, R] = $,
        $e = ji(A, x, l),
        At = Bi(Q.shape, $e, L, t, a, n, o),
        Et = Hi(Q, $e, L.shape, t, a, n, o)
      if (R != null) {
        const ii = Wi(g, $e)
        return [At, Et, ii]
      }
  ...
  return u == null
    ? Le(($, L, Q) => {
        ...
        return (
          Q([L, $, x]),
          b && (x = v(x, [x.shape[1], x.shape[2], x.shape[3]])),
          { value: x, gradFunc: k }
        )
      })(h, d)
    : Le(($, L, Q, x) => {
        ...
        return (
          x([L, $, R, Q]),
          b && (R = v(R, [R.shape[1], R.shape[2], R.shape[3]])),
          { value: R, gradFunc: k }
        )
      })(h, d, g)
}
 ...
 * =============================================================================
 */
const dh = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
...
const bh = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      maxNorm: hh,
...
const zh = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      constant: Th,
...
const Zf = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      Layer: _u,
...
const dy = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      MAPE: uy,
 ...
 * =============================================================================
 */
const hy = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      modelFromJSON: Fu,
      ...
      this.mode === 'min'
        ...
        : this.mode === 'max'
          ...
          : this.monitor.indexOf('acc') !== -1
            ? (this.monitorFunc = zt)
            : (this.monitorFunc = fe),
      this.monitorFunc === fe && (this.minDelta *= -1))
  }
  async onTrainBegin(e) {
    ;((this.wait = 0),
      ...
      this.baseline != null
        ...
        : (this.best = this.monitorFunc === fe ? 1 / 0 : -1 / 0))
  }
      ...
      l =
        n.inputIndexEnd === 0
          ...
          : n.inputIndexEnd === void 0
            ? u + 1
            : n.inputIndexEnd
    if (n.type === 'tensor') return E(e.inputNames[n.inputIndexStart], t, a, r)
    if (n.type === 'tensors')
      return e.inputNames.slice(u, l).map((d) => E(d, t, a, r))
    const m = E(e.inputNames.slice(u)[0], t, a, r),
      p = m.dataSync()
...
function P(s, e) {
  const [t, a, r] = D(s)
  return [_e(t, e && e.currentContextId), a, r]
}
function _e(s, e) {
  return e ? `${s}-${e}` : s
}
function D(s) {
  const e = s.split(':')
  if (e.length === 1) return [s, 0, void 0]
  const t = e[0],
    a = e.length === 3 ? e[1] : void 0,
    r = Number(e[e.length - 1])
  return [t, r, a]
}
function be(s, e, t) {
  let a = i('pad', s, e, t)
...
class Lt {
  ...
  transformGraph(e, t = {}) {
    const a = e.node,
      ...
      u = a.reduce(
        (f, g) => (
          (f[g.name] = this.mapNode(g)),
          g.op.startsWith('Placeholder')
            ? r.push(f[g.name])
            : g.op === 'Const'
              ? n.push(f[g.name])
              : (g.input == null || g.input.length === 0) && o.push(f[g.name]),
          f
        ),
        {}
      )
    ...
    let p = {},
      c = {}
    t != null &&
      ((p = this.mapSignatureEntries(t.inputs)),
    ...
    e.library != null &&
      ...
      (h = e.library.function.reduce(
        (f, g) => ((f[g.signature.name] = this.mapFunction(g)), f),
        {}
      ))
    const b = {
      nodes: u,
    ...
    return (
      ...
      t.attrs != null &&
        (a.attrParams = t.attrs.reduce((r, n) => {
          ...
          switch (n.type) {
            case 'string':
              ;((u = Ve(e.attr, n.tfName, n.defaultValue)),
                u === void 0 &&
                  n.tfDeprecatedName &&
                  (u = Ve(e.attr, n.tfDeprecatedName, n.defaultValue)))
              break
            case 'string[]':
              ;((u = Ue(e.attr, n.tfName, n.defaultValue)),
                u === void 0 &&
                  n.tfDeprecatedName &&
                  (u = Ue(e.attr, n.tfDeprecatedName, n.defaultValue)))
              break
            case 'number':
              ;((u = je(e.attr, n.tfName, n.defaultValue || 0)),
                u === void 0 &&
                  n.tfDeprecatedName &&
                  (u = je(e.attr, n.tfDeprecatedName, n.defaultValue)))
              break
            case 'number[]':
              ;((u = qe(e.attr, n.tfName, n.defaultValue)),
                u === void 0 &&
                  n.tfDeprecatedName &&
                  (u = qe(e.attr, n.tfDeprecatedName, n.defaultValue)))
              break
            case 'bool':
              ;((u = Re(e.attr, n.tfName, n.defaultValue)),
                u === void 0 &&
                  n.tfDeprecatedName &&
                  (u = Re(e.attr, n.tfDeprecatedName, n.defaultValue)))
              break
            case 'bool[]':
              ;((u = Ke(e.attr, n.tfName, n.defaultValue)),
                u === void 0 &&
                  n.tfDeprecatedName &&
                  (u = Ke(e.attr, n.tfDeprecatedName, n.defaultValue)))
              break
            case 'shape':
              ;((u = We(e.attr, n.tfName, n.defaultValue)),
                u === void 0 &&
                  n.tfDeprecatedName &&
                  (u = We(e.attr, n.tfDeprecatedName, n.defaultValue)))
              break
            case 'shape[]':
              ;((u = Ge(e.attr, n.tfName, n.defaultValue)),
                u === void 0 &&
                  n.tfDeprecatedName &&
                  (u = Ge(e.attr, n.tfDeprecatedName, n.defaultValue)))
              break
            case 'dtype':
              ;((u = Be(e.attr, n.tfName, n.defaultValue)),
                u === void 0 &&
                  n.tfDeprecatedName &&
                  (u = Be(e.attr, n.tfDeprecatedName, n.defaultValue)))
              break
            case 'dtype[]':
              ;((u = He(e.attr, n.tfName, n.defaultValue)),
                u === void 0 &&
                  n.tfDeprecatedName &&
                  (u = He(e.attr, n.tfDeprecatedName, n.defaultValue)))
              break
            case 'func':
              ;((u = Ft(e.attr, n.tfName, n.defaultValue)),
                u === void 0 &&
                  n.tfDeprecatedName &&
                  (u = Ft(e.attr, n.tfDeprecatedName, n.defaultValue)))
              break
            case 'tensor':
            case 'tensors':
              break
...
class lg {
  ...
  getAttr(e, t) {
    ...
    if (a.i != null || a.f != null) return je(this.node.rawAttrs, e, t)
    if (a.s != null) return Ve(this.node.rawAttrs, e, t)
    if (a.b != null) return Re(this.node.rawAttrs, e, t)
    if (a.shape != null) return We(this.node.rawAttrs, e, t)
    if (a.type != null) return Be(this.node.rawAttrs, e, t)
    if (a.list != null) {
      if (a.list.i != null || a.list.f != null)
        return qe(this.node.rawAttrs, e, t)
      if (a.list.s != null) return Ue(this.node.rawAttrs, e, t)
      if (a.list.shape != null) return Ge(this.node.rawAttrs, e, t)
      if (a.list.b != null) return Ke(this.node.rawAttrs, e, t)
      if (a.list.type != null) return He(this.node.rawAttrs, e, t)
    }
    return t
  }
}
...
class cg {
  ...
  gather(e, t) {
    ...
    if (e.length === 0) return U([], [0].concat(this.elementShape))
    const a = this.readMany(e)
    return (
      I(this.elementShape, a[0].shape, 'TensorArray shape mismatch: '),
      ee(a, 0)
    )
  }
  /**
  ...
  concat(e) {
    ...
    if (this.size() === 0) return U([], [0].concat(this.elementShape))
    const t = []
  ...
  split(e, t) {
    ...
    const u = []
    for (let l = 0; l < e.length; l++) u[l] = l
    this.writeMany(u, o)
  }
}
/**
...
class J {
  ...
  popBack(e, t) {
    ...
    const a = re(this.elementShape, this.tensors, e),
      r = this.tensors.pop()
    return (
      (r.kept = !1),
      I(r.shape, e, 'TensorList shape mismatch: '),
      v(r, a)
    )
  }
  /**
  ...
  pushBack(e) {
    ...
    if (
      (I(e.shape, this.elementShape, 'TensorList shape mismatch: '),
  ...
  setItem(e, t) {
    ...
    ;(I(this.elementShape, t.shape, 'TensorList shape mismatch: '),
      H(t),
  ...
  gather(e, t, a) {
    ...
    ;(I(this.elementShape, a, 'TensorList shape mismatch: '),
...
function yg(s, e, t) {
  ...
  for (let p = 0; p < l.length; p++) m.setItem(p, l[p])
  return m
}
/**
 * @license
  ...
  switch (s.op) {
    ...
    case 'StatelessWhile': {
      const a = i('body', s, e, t),
        r = i('cond', s, e, t),
        n = i('args', s, e, t),
        o = await t.functionMap[r].executeFunctionAsync(
          n,
          t.tensorArrayMap,
          t.tensorListMap
        ),
      ...
      for (; l[0]; ) {
        const p = m
        m = await t.functionMap[a].executeFunctionAsync(
          m,
          t.tensorArrayMap,
          t.tensorListMap
        )
    ...
    case 'TensorArrayV3': {
      const a = i('size', s, e, t),
        ...
        o = i('dynamicSize', s, e, t),
        u = i('clearAfterRead', s, e, t),
        l = i('identicalElementShapes', s, e, t),
        m = i('name', s, e, t),
        p = new cg(m, r, a, n, l, o, u)
    ...
    case 'TensorListResize': {
      const a = i('tensorListId', s, e, t),
        r = i('size', s, e, t),
        o = t.getTensorList(a.id).resize(r)
      return (t.addTensorList(o), [o.idTensor])
    }
    default:
      throw TypeError(`Node type ${s.op} is not implemented`)
  ...
  switch (s.op) {
    ...
    case 'Conv2D': {
      const r = i('strides', s, e, t),
        ...
        u = i('dilations', s, e, t)
      return [
        a.conv2d(i('x', s, e, t), i('filter', s, e, t), [r[1], r[2]], n, o, [
          u[1],
          u[2],
        ]),
      ]
    ...
    case 'MaxPoolWithArgmax': {
      const r = i('strides', s, e, t),
        n = i('pad', s, e, t),
        o = i('kernelSize', s, e, t),
        u = i('includeBatchInIndex', s, e, t),
        { result: l, indexes: m } = a.maxPoolWithArgmax(
          i('x', s, e, t),
          [o[1], o[2]],
          [r[1], r[2]],
          n,
    ...
    case 'AvgPool3D': {
      const r = i('strides', s, e, t),
        ...
        o = i('kernelSize', s, e, t)
      return [
        a.avgPool3d(i('x', s, e, t), [o[1], o[2], o[3]], [r[1], r[2], r[3]], n),
      ]
    }
    case 'MaxPool3D': {
      const r = i('strides', s, e, t),
        ...
        o = i('kernelSize', s, e, t)
      return [
        a.maxPool3d(i('x', s, e, t), [o[1], o[2], o[3]], [r[1], r[2], r[3]], n),
      ]
    }
    case 'Dilation2D': {
      const r = i('strides', s, e, t),
...
function Ie(s, e, t) {
  const a = i('boxes', s, e, t),
    ...
    o = i('iouThreshold', s, e, t),
    u = i('scoreThreshold', s, e, t),
  ...
  switch (s.op) {
    case 'NonMaxSuppressionV5': {
      const {
        ...
        c = await r.image.nonMaxSuppressionWithScoreAsync(n, o, u, l, m, p)
    ...
    case 'NonMaxSuppressionV4': {
      const {
        ...
        p = i('padToMaxOutputSize', s, e, t),
        c = await r.image.nonMaxSuppressionPaddedAsync(n, o, u, l, m, p)
    ...
    return (
      ...
      C(() => {
        ...
        N(
          n === o,
          () =>
            `The number of elements doesn't match, keys has ${n} elements, the values has ${o} elements.`
        )
        for (let u = 0; u < n; u++) {
          const l = a[u],
            m = r[u]
...
const Og = async (s, e, t, a) => {
  switch (s.op) {
    case 'HashTable':
    case 'HashTableV2': {
      const r = i('keyDType', s, e, t),
        n = i('valueDType', s, e, t),
        o = new vg(r, n)
  ...
  switch (s.op) {
    case 'ResizeBilinear': {
      const r = i('images', s, e, t),
        n = i('size', s, e, t),
        o = i('alignCorners', s, e, t),
        u = i('halfPixelCenters', s, e, t)
...
const kg = (s, e, t, a = _) => {
  switch (s.op) {
    ...
    case 'SparseToDense':
      return [
        a.sparseToDense(
          i('sparseIndices', s, e, t),
          i('outputShape', s, e, t),
          i('sparseValues', s, e, t),
  ...
  switch (s.op) {
    ...
    case 'Reverse': {
      const r = i('dims', s, e, t),
        n = []
      for (let u = 0; u < r.length; u++) r[u] && n.push(u)
      const o = i('x', s, e, t)
    ...
    case 'StridedSlice': {
      const r = i('begin', s, e, t),
        ...
        u = i('beginMask', s, e, t),
        l = i('endMask', s, e, t),
        m = i('ellipsisMask', s, e, t),
        p = i('newAxisMask', s, e, t),
    ...
    case 'SparseToDense': {
      const r = i('sparseIndices', s, e, t),
        ...
        o = i('sparseValues', s, e, t),
        u = i('defaultValue', s, e, t)
      return [
        a.sparseToDense(r, o, n, o.dtype === u.dtype ? u : a.cast(u, o.dtype)),
      ]
    }
    default:
      throw TypeError(`Node type ${s.op} is not implemented`)
...
function Rt(s, e, t, a, r = C) {
  const n = ((o, u, l) => {
    switch (o.category) {
      ...
      case 'custom':
        const m = Un(o.op)
        if (m && m.customExecutor) return m.customExecutor(new lg(o, u, l))
        throw TypeError(`Custom op ${o.op} is not registered.`)
      default:
        throw TypeError(
          `Unknown op '${o.op}'. File an issue at https://github.com/tensorflow/tfjs/issues so we can add it, or register a custom execution with tf.registerOp()`
        )
    }
  })(s, e, t)
...
function Bt(s, e, t, a) {
  ...
  for (; c.length > 0; ) {
    ...
    if (
      ((Jn(d) || Rg(d) || jg(d)) &&
        o == null &&
        ((o = d), (u = o.children.map((h) => h.name).filter((h) => r.has(h)))),
      r.add(d.name),
      t[d.name] == null && m.indexOf(d.name) === -1 && p.indexOf(d.name) === -1)
    ) {
...
class Ae {
   ...
   */
  compile(e, t) {
    const a = Bt(e, t, this.weightMap, this._initNodes),
      { missingInputs: r, dynamicNode: n, syncInputs: o } = a
    if (n != null)
      throw new Error(
        `This execution contains the node '${n.name}', which has the dynamic op '${n.op}'. Please use model.executeAsync() instead. Alternatively, to avoid the dynamic ops, specify the inputs [${o}]`
      )
    if (r.length > 0) {
      const u = t.map((m) => m.name),
        l = Object.keys(e)
      throw new Error(
        `Cannot compute the outputs [${u}] from the provided inputs [${l}]. Missing the following inputs: [${r}]`
      )
    }
  ...
  execute(e, t) {
    ...
    ;(this.checkInputs(e),
      ...
      (t = this.mapOutputs(t)),
      this.checkOutputs(t))
    const r = a.map((c) => this.graph.nodes[D(c)[0]]),
      n = t.map((c) => D(c)[0])
    ...
    const m = {},
      p = {}
    return C(() => {
      const c = new jt(this.weightMap, m, p, this.functionExecutorMap),
      ...
      const h = this.getFrozenTensorIds(d),
        b = {}
      for (let f = 0; f < l.length; f++) {
        ...
        if (!d[g.name]) {
          ...
          if (ve(S))
            throw new Error(
              `The execution of the op '${g.op}' returned a promise. Please use model.executeAsync() instead.`
            )
          ;((d[g.name] = S),
            this.checkTensorForDisposal(g.name, g, d, c, h, n, b))
        }
      }
          ...
          m != null &&
            m.forEach((p) => {
              if (p && !p.kept && !n.has(p.id)) {
                const c = u[p.id]
                if (c === 1) {
                  if (!this.keepTensorForDebug) p.dispose()
                  else {
                    const [d, h] = P(t.name, r)
                    this.intermediateTensors[d]
                      ? (this.intermediateTensors[d][h] = p)
                      : ((this.intermediateTensors[d] = []),
                        (this.intermediateTensors[d][h] = p))
                  }
                  delete u[p.id]
  ...
  async _executeAsync(e, t, a = !1, r = {}, n = {}) {
    ...
    const u = t.map((p) => E(p, this.tensorsMap, o)),
      l = u.map((p) => p.id),
      m = Object.keys(e).map((p) => e[p].id)
    return (
      (this.keepIds = /* @__PURE__ */ new Set([...l, ...m, ...this.weightIds])),
      this.keepTensorForDebug || this.disposeTensorsMap(),
      this.parent == null && o.dispose(this.keepIds),
      u
    )
  }
  ...
  async executeWithControlFlow(e, t, a, r) {
    const n = Object.keys(e),
      o = n.map((T) => this.graph.nodes[D(T)[0]]),
      u = a.map((T) => D(T)[0])
    ...
    const {
        ...
        dynamicNode: c,
        syncInputs: d,
      } = Bt(e, l, this.weightMap, this._initNodes),
      h = [...o, ...this.graph.weights, ...(this._initNodes || [])].map(
    ...
    if (k.length > 0) {
      ...
      throw (
        c != null &&
          (T = `Alternatively, to avoid the dynamic ops, use model.execute() and specify the inputs [${d}]`),
        new Error(
          `Cannot compute the outputs [${k}] from the provided inputs [${n}]. Consider providing the following inputs: [${p}]. ${T}`
        )
      )
    }
    return b
      ...
      if (
        ...
        ve(h)
          ? p.push(
              h.then(
                (f) => (
                  (r[d] = f),
                  (a.currentContext = b),
                  this.checkTensorForDisposal(d, c.node, r, a, o, u, l),
          ...
          : ((r[d] = h),
            this.checkTensorForDisposal(d, c.node, r, a, o, u, l),
            this.processChildNodes(c.node, t, a, r, n, m))
      } else this.processChildNodes(c.node, t, a, r, n, m)
    }
    return p
  }
  processChildNodes(e, t, a, r, n, o) {
    e.children.forEach((u) => {
      ...
      n[l] ||
        !o.has(u.name) ||
        (u.op === 'Merge'
          ? u.inputNames.some((m) => !!E(m, r, a)) &&
            ((n[l] = !0), t.push({ contexts: a.currentContext, node: u }))
          : u.inputNames.every((m) => !!E(m, r, a)) &&
            ((n[l] = !0), t.push({ contexts: a.currentContext, node: u })))
    })
  }
  /**
  ...
  checkInputShapeAndType(e) {
    Object.keys(e).forEach((t) => {
      ...
      if (n.attrParams.shape && n.attrParams.shape.value) {
        const o = n.attrParams.shape.value,
          u =
            o.length === a.shape.length &&
            a.shape.every((l, m) => o[m] === -1 || o[m] === l)
        N(
          u,
          () =>
            `The shape of dict['${n.name}'] provided in model.execute(dict) must be [${o}], but was [${a.shape}]`
        )
      }
      n.attrParams.dtype &&
...
class vt {
  ...
  loadSync(e) {
    ...
    if (this.artifacts.userDefinedMetadata != null) {
      ...
      ;(n.signature != null && (a = n.signature),
    ...
    if (
      ((this.executor = new Ae(Lt.Instance.transformGraph(t, this.signature))),
  ...
  normalizeInputs(e) {
    if (!(e instanceof me) && !Array.isArray(e)) return e
...
const ye = '"',
  ...
  Ht = Symbol('field'),
  ge = Symbol('quote'),
  Ce = Symbol('quoteafterquote'),
  Wt = Symbol('quoteinquote')
class Zn extends dt {
  /**
   * Create a `CSVDataset`.
   *
  ...
  async setColumnNames() {
    ...
    if (
      (N(a.length === 0, () => 'Duplicate column names found: ' + a.toString()),
      this.columnConfigs)
    ) {
  ...
  makeDataElement(e) {
    ...
    for (let n = 0; n < this.fullColumnNames.length; n++) {
      const o = this.fullColumnNames[n],
        u = this.columnConfigs ? this.columnConfigs[o] : null
      if (!(this.configuredColumnsOnly && !u)) {
        const l = t[n]
        let m = null
        if (l === '')
          if (u && u.default !== void 0) m = u.default
          else {
            if (u && (u.required || u.isLabel))
              throw new Error(
                `Required column ${o} is empty in this line: ${e}`
              )
            m = void 0
          }
        else {
  ...
  parseRow(e, t = !0) {
    ...
    if (
      (o === Ce ? a.push(e.substring(r, n - 1)) : a.push(e.substring(r)),
...
class _t extends Ee {
  constructor(e, t) {
    if (
      ...
      } else this.cropBox = Se([0, 0, 1, 1], [1, 4])
  }
  summary() {
    return 'webcam'
  }
    ...
    ;(super(),
      ...
      N(
        e instanceof Uint8Array ||
          (z().get('IS_BROWSER') ? e instanceof File || e instanceof Blob : !1),
        () =>
          ...
          value: await new Promise((t, a) => {
            ...
            if (this.file instanceof Uint8Array)
              ...
              ;((n.onload = (u) => {
                ...
                (n.onabort = (u) => a(new Error('Aborted'))),
                (n.onerror = (u) => a(new Error(u.type))))
...
class ai extends Yn {
  ...
  async iterator() {
    return ti(this.url)
      ? new si(this.url, this.fileOptions).iterator()
      : Yg(this.url, this.fileOptions)
  }
}
/**
 * @license
...
class mb {
  constructor({
    ...
    ;((this.container = e),
      ...
      (this.filterMinCF = u),
      (this.filterBeta = l),
      (this.warmupTolerance = m),
      (this.missTolerance = p),
      (this.ui = new od({ uiLoading: r, uiScanning: n, uiError: o })),
      (this.scene = new kt()),
      (this.cssScene = new kt()),
      (this.renderer = new oi({ antialias: !0, alpha: !0 })),
      (this.cssRenderer = new id({ antialias: !0 })),
      (this.renderer.outputEncoding = ui),
            ...
            if (n.type === 'updateMatrix') {
              ...
              for (let m = 0; m < this.anchors.length; m++)
                if (this.anchors[m].targetIndex === o) {
                  if (
                    (this.anchors[m].css
                      ? this.anchors[m].group.children.forEach((p) => {
                          p.element.style.visibility =
                            u === null ? 'hidden' : 'visible'
                        })
                      : (this.anchors[m].group.visible = u !== null),
                    u !== null)
                  ) {
                    let p = new xe()
                    ;((p.elements = [...u]),
                      p.multiply(this.postMatrixs[o]),
                      this.anchors[m].css && p.multiply(ni),
                      (this.anchors[m].group.matrix = p))
                  }
                  ;(this.anchors[m].visible &&
                    u === null &&
                    ((this.anchors[m].visible = !1),
                    this.anchors[m].onTargetLost &&
                      this.anchors[m].onTargetLost()),
                    !this.anchors[m].visible &&
                      u !== null &&
                      ((this.anchors[m].visible = !0),
                      this.anchors[m].onTargetFound &&
                        this.anchors[m].onTargetFound()),
                    this.anchors[m].onTargetUpdate &&
                      this.anchors[m].onTargetUpdate())
                }
              this.anchors.reduce((m, p) => m || p.visible, !1)
  ...
  resize() {
    ...
    const l = n.videoWidth / n.videoHeight,
      m = r.clientWidth / r.clientHeight
    l > m
      ? ((u = r.clientHeight), (o = u * l))
      : ((o = r.clientWidth), (u = o / l))
    const p = this.controller.getProjectionMatrix(),
      c = (2 * Math.atan((1 / p[5] / u) * r.clientHeight) * 180) / Math.PI,
      d = p[14] / (p[10] - 1),
      h = p[14] / (p[10] + 1)
    ;(p[5] / p[0],
      (a.fov = c),
      ...
      (n.style.top = -(u - r.clientHeight) / 2 + 'px'),
      (n.style.left = -(o - r.clientWidth) / 2 + 'px'),
      (n.style.width = o + 'px'),
      (n.style.height = u + 'px'))
    ...
    ;((b.style.position = 'absolute'),
      (b.style.left = 0),
      (b.style.top = 0),
      (b.style.width = r.clientWidth + 'px'),
      (b.style.height = r.clientHeight + 'px'),
      (f.style.position = 'absolute'),
      (f.style.left = 0),
      (f.style.top = 0),
      (f.style.width = r.clientWidth + 'px'),
      (f.style.height = r.clientHeight + 'px'),
